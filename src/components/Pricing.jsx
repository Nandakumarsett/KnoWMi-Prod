            ...
            return (
              <div key={plan.id} 
                className={`reveal reveal-delay-${i + 1} relative flex flex-col rounded-[2.5rem] p-8 transition-all duration-500 border group ${
                  plan.featured 
                    ? 'bg-white border-orange-500 shadow-[0_40px_80px_-15px_rgba(255,153,51,0.15)] md:-translate-y-4 z-20' 
                    : 'bg-white border-neutral-100 shadow-sm hover:border-neutral-200 md:hover:-translate-y-1'
                }`}
              >
                {plan.featured && (

...
import { Github, ExternalLink, Code2, Terminal, Award } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#0d1117] text-[#e6edf3] font-mono selection:bg-[#3fb95033] selection:text-[#3fb950]">
      ...
      <main className="max-w-[480px] mx-auto pt-24 pb-12 px-6 flex flex-col items-center">
        ...
        <div className="relative mb-8 group">
          <div 
            className="w-32 h-32 bg-[#30363d] flex items-center justify-center overflow-hidden transition-transform duration-500 group-hover:scale-105"
            style={{ 
              clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)',
              padding: '2.5px',
              background: `linear-gradient(135deg, ${accentGreen}, #79c0ff)`
            }}
          >
            <div 
              className="w-full h-full bg-[#0d1117] overflow-hidden"

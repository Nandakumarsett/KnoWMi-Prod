      ...
      <main className="max-w-[480px] mx-auto pt-8 pb-12 px-6 relative z-10">
        ...
        <div className="flex flex-col items-center mb-10">
           <div className="relative mb-6">
              <div className="w-32 h-32 rounded-3xl p-1 bg-gradient-to-br from-[#00FFAA] to-[#00BFFF] shadow-[0_0_30px_#00FFAA33]">
                <div className="w-full h-full rounded-[22px] bg-[#080810] overflow-hidden border-4 border-[#080810]">

        ...
        <div className="w-full mt-12 space-y-12">
          ...
          {data.collab_types && (
            <section className="bg-black text-white rounded-[32px] p-8 text-center relative overflow-hidden shadow-2xl">
               ...
               <p className="text-lg font-black tracking-tight mb-2">Open to: {data.collab_types}</p>
               {data.collab_formats && <p className="text-xs font-medium text-white/60">{data.collab_formats}</p>}
            </section>
          )}
        </div>

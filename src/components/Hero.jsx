        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center py-12 lg:py-4">
          ...
          <div className="max-w-[560px]">
            ...
            <div data-fade className="mb-4 flex items-center gap-3 flex-wrap">
              <span className="tag px-4 py-1.5 rounded-xl flex items-center gap-2" style={{ background: 'var(--saffron-light)', color: 'var(--saffron)', border: '1px solid rgba(255,153,51,0.1)' }}>
                <span className="flex items-center justify-center w-5 h-5 rounded-full bg-white shadow-sm text-[10px]">🇮🇳</span> India's First
              </span>
              <span className="tag px-4 py-1.5 rounded-xl flex items-center gap-2" style={{ background: 'var(--green-light)', color: 'var(--green-india)', border: '1px solid rgba(22,163,74,0.1)' }}>
                ✦ QR Identity Tee
              </span>
            </div>
          ...
          <div className="flex flex-col items-center lg:items-end justify-center relative" data-fade>
            ...
            {/* Floating stat cards */}
            <div className="absolute left-0 top-[15%] hidden lg:block" style={{ animation: 'float 4s ease-in-out infinite', animationDelay: '0.5s' }}>
            ...
            <div className="absolute right-0 bottom-[20%] hidden lg:block" style={{ animation: 'float 5s ease-in-out infinite', animationDelay: '1.2s' }}>

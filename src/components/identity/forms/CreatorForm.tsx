...
export function CreatorForm({ data = {}, onChange, onUpload, uploading }: CreatorFormProps) {
  ...
  const charCountClasses = (current: number, max: number) => 
    `text-[10px] font-bold absolute right-3 top-1.5 ${current > max ? 'text-red-500' : 'text-neutral-500'}`;

  return (
    <div className="space-y-6 py-4 animate-fadeIn max-w-4xl mx-auto pb-20">

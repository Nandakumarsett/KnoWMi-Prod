        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-14">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-3">
              <a href="https://instagram.com/knowmi.in" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Opens in a new tab" className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200"
              ...
              <a href="https://twitter.com/knowmi_in" target="_blank" rel="noopener noreferrer" aria-label="Twitter" title="Opens in a new tab" className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200"
                style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.4)' }}
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,153,51,0.15)'; e.currentTarget.style.borderColor = 'rgba(255,153,51,0.25)'; e.currentTarget.style.color = 'var(--saffron)' }}
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.06)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.color = 'rgba(255,255,255,0.4)' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>
              </a>
              <a href="https://linkedin.com/company/knowmi-india" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="Opens in a new tab" className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200"
                style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.4)' }}
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,153,51,0.15)'; e.currentTarget.style.borderColor = 'rgba(255,153,51,0.25)'; e.currentTarget.style.color = 'var(--saffron)' }}
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.06)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.color = 'rgba(255,255,255,0.4)' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href="https://youtube.com/@knowmi_india" target="_blank" rel="noopener noreferrer" aria-label="YouTube" title="Opens in a new tab" className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200"
                style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.4)' }}
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,153,51,0.15)'; e.currentTarget.style.borderColor = 'rgba(255,153,51,0.25)'; e.currentTarget.style.color = 'var(--saffron)' }}
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.06)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.color = 'rgba(255,255,255,0.4)' }}>

...
const personas = [
  ...
  },
  {
    ...
    profile: {
      avatar: '🎨', name: 'Alex Rivera', role: 'Digital Artist · Creator',
      bio: 'Creating immersive digital experiences through art and code. Building a community of creators who wear their story.',
      links: [
        { icon: '💼', label: 'LinkedIn', sub: 'alexrivera-art' },
        { icon: '🎨', label: 'Portfolio', sub: 'behance.net/alexrivera' },
        { icon: '💬', label: 'WhatsApp', sub: 'Get in touch' },
        { icon: '💌', label: 'Email', sub: 'collabs@alexrivera.com' },
      ],
      ...
      <div className="relative w-full max-w-sm rounded-3xl overflow-hidden"
        ...
        <div className="flex flex-col items-center px-6 pt-4 pb-3">
          <div className="w-20 h-20 rounded-3xl flex items-center justify-center overflow-hidden mb-3"
            ...
            {p.avatar.startsWith('/') ? (
              <img src="/assets/placeholder-avatar.png" alt={p.name} className="w-full h-full object-cover" />
            ) : (

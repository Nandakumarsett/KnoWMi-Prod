...
export default function OrdersAdmin() {
  ...
  const handleUpdateOrder = async (id) => {
    setLoading(true)
    const { profiles, order_number, ...updateData } = editForm
      ...
      {editingId === 'new' && (
        <div className="card p-8 bg-orange-50 border-orange-200 mb-8 animate-slideUp">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              <label className="text-[10px] font-black uppercase mb-1 block">Order # (Auto-Generated)</label>
              <input 
                type="text"
                readOnly
                disabled
                value="Auto-generated by SQL Sequence (KWM-XXXX)"
                className="w-full px-4 py-2.5 rounded-xl text-sm border-none bg-neutral-900 text-neutral-400 font-mono shadow-[2px_2px_0px_#fff] outline-none cursor-not-allowed"
              />
            </div>
            <div>

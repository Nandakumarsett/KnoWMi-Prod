...
import { Sparkles, Trophy, UserPlus, Share2, Instagram, Twitter, Linkedin, Film, Github, Music, ChevronLeft, ChevronRight, GraduationCap, Code } from 'lucide-react';
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setStats(prev => ({
        ...
        studentCity: CITIES[Math.floor(Math.random() * CITIES.length)],
        techViews: prev.techViews + Math.floor(Math.random() * 4) + 1,
        techCity: CITIES[Math.floor(Math.random() * CITIES.length)]
      }));
    }, 3000);
          ...
          >
            ...
            >
              ...
              <div className="px-5 pb-32">
                ...
                <div className="relative h-4 mb-12">
                  <div className="absolute -top-12 left-1/2 -translate-x-1/2">
                    <div className="w-24 h-24 p-1 rounded-full bg-gradient-to-tr from-purple-600 to-pink-500">
                      <div className="w-full h-full bg-white p-0.5 rounded-full overflow-hidden shadow-inner">
                        <img 
                    ...
                    <div className="absolute bottom-1 right-1 w-6 h-6 bg-white rounded-full shadow-lg flex items-center justify-center border border-neutral-100">
                      <div className="text-purple-600 text-[10px]"><GraduationCap size={11} /></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[7px] font-black text-purple-600 uppercase tracking-[0.4em] mb-3">CS STUDENT & TEDx LEAD</p>
                  ...
                  <div className="flex justify-evenly items-start w-full mb-6 border-y border-neutral-100 py-4 transition-all duration-500">
                    <div className="flex flex-col items-center text-center">
                      <span className="text-2xl font-black text-neutral-900 leading-none mb-1.5 tabular-nums">
                        {(stats.studentViews/1000).toFixed(1)}K
                      </span>
                      <p className="text-[7px] font-black uppercase text-neutral-400 tracking-widest">Profile Views</p>
                    </div>
                    <div className="flex flex-col items-center text-center">
                      <span 
                        className="text-2xl font-black leading-none mb-1.5 text-pink-500"
                      >
                        {stats.studentCity.name}
                      </span>
                      <p className="text-[7px] font-black uppercase text-neutral-400 tracking-widest">Most Scanned Place</p>
                    </div>
                  </div>
                  ...
                  <div className="w-full">
                    <div className="flex justify-between items-end mb-3">
                       <div>
                         <h4 className="text-[8px] font-black uppercase tracking-[0.2em] text-neutral-900 leading-none">Latest Projects</h4>
            ...
            >
              ...
              <div className="px-5 pb-32">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[7px] font-black text-teal-400 uppercase tracking-[0.4em] mb-3">SOFTWARE ENGINEER</p>
                  ...
                  {/* Pulse Section (Live Randomization) */}
                  <div className="flex justify-evenly items-start w-full mb-6 border-y border-teal-500/10 py-4 transition-all duration-500">
                    <div className="flex flex-col items-center text-center">
                      <span className="text-2xl font-black text-white leading-none mb-1.5 tabular-nums">
                        {(stats.techViews/1000).toFixed(1)}K
                      </span>
                      <p className="text-[7px] font-black uppercase text-teal-600/60 tracking-widest">Commits / Views</p>
                    </div>
                    <div className="flex flex-col items-center text-center">
                      <span 
                        className="text-2xl font-black leading-none mb-1.5 text-teal-400"
                      >
                        {stats.techCity.name}
                      </span>
                      <p className="text-[7px] font-black uppercase text-teal-600/60 tracking-widest">Most Scanned Place</p>
                    </div>
                  </div>

                  {/* Network Presence */}
                  <div className="w-full mb-6">
                     <p className="text-[8px] font-black uppercase tracking-[0.2em] text-white/80 mb-3">Dev Handles</p>
                     <div className="flex gap-3">
                        <a href="#" onClick={e => e.preventDefault()} className="w-8 h-8 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center justify-center text-white hover:text-teal-400 hover:scale-105 transition-all"><Github size={14} /></a>
                        <a href="#" onClick={e => e.preventDefault()} className="w-8 h-8 rounded-lg bg-[#0077B5] flex items-center justify-center text-white hover:scale-105 transition-all"><Linkedin size={14} /></a>
                        <a href="#" onClick={e => e.preventDefault()} className="w-8 h-8 rounded-lg bg-black flex items-center justify-center text-white hover:scale-105 transition-all"><Twitter size={14} /></a>
                     </div>
                  </div>

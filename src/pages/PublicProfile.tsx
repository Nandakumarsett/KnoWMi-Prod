        ...
        <div className="flex gap-12 items-start justify-center">
          ...
          <div className="w-[380px] shrink-0 sticky top-28">
            <div className="bg-white rounded-[24px] p-10 shadow-2xl text-[#1A1A1A] border border-[#E5D5C4] flex flex-col items-center">
              ...
              <h1 className="text-4xl font-black tracking-tight mb-2 text-center text-[#1A1A1A]">{profile.display_name}</h1>
              <p className="text-xs font-black uppercase tracking-[0.2em] opacity-30 mb-6 text-center text-[#1A1A1A]">{profile.member_id}</p>

      ...
      <header className="sticky top-0 bg-white/80 backdrop-blur-xl border-b border-neutral-100/50 z-50">
        <div className="max-w-[800px] mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 pr-2">
            ...
            <div className="w-10 h-10 rounded-2xl bg-neutral-100 overflow-hidden border-2 border-white shadow-sm">
               {profile?.avatar_url ? <img src={profile.avatar_url} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-orange-100" />}
            </div>
          </div>
        </div>
      </header>

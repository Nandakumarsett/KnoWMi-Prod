          ...
          {identities.map(idnt => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                {!idnt.active && (
                  <button 
                    onClick={(e) => handleDelete(idnt.id, e)}
                    className="w-10 h-10 rounded-xl bg-neutral-50 flex items-center justify-center text-neutral-300 hover:text-ruby-500 hover:bg-ruby-50 transition-all active:scale-90"

        ...
        <div className="relative group">
          ...
          >
            ...
            <div className="flex flex-col items-center -mt-4 mb-3">
              <img src="/logo-square.webp" fetchpriority="high" loading="eager" className="w-36 h-36 object-contain -mb-10 bg-transparent border-none shadow-none" style={{ filter: 'invert(1) hue-rotate(180deg)' }} alt="KnoWMi Logo" />
            ...
            <div className="relative w-64 h-64 mb-6 flex items-center justify-center">
              ...
              {isPaid && (
                <div className="absolute inset-0 m-auto w-10 h-10 bg-black border-[3px] border-orange-500 rounded-xl flex items-center justify-center z-20 select-none overflow-hidden">
                  <img src="/favicon.png" fetchpriority="high" loading="eager" className="w-full h-full object-contain p-1" style={{ filter: 'invert(1) hue-rotate(180deg)' }} alt="KnoWMi Logo" />
                </div>
              )}

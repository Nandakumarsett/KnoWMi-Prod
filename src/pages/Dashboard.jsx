            ...
            <div className="relative w-64 h-64 mb-6 flex items-center justify-center">
              ...
              {isPaid && (
                <div className="absolute inset-0 m-auto w-12 h-12 bg-black border-[3px] border-orange-500 rounded-xl flex items-center justify-center z-20 select-none overflow-hidden">
                  <img src="/favicon.png" fetchpriority="high" loading="eager" className="w-full h-full object-contain p-1" alt="KnoWMi Logo" />
                </div>
              )}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="card p-6 lg:p-8 bg-[#1a1a1a] border border-white/20 shadow-[8px_8px_0px_#fff] rounded-[32px] flex flex-col justify-between">
                      ...
                      <div className="pt-4 space-y-2 text-xs">
                        ...
                        <div className="flex justify-between items-center bg-[#0a0a0a] p-2.5 rounded-xl border border-neutral-800">
                          ...
                          <span className="font-mono text-white text-[11px] font-bold select-all">
                            {latestOrder.payment_id || 'pay_verified_razorpay'}
                          </span>
                        </div>

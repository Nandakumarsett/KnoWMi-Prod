      ...
      <div className="max-w-[900px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8">
        <div className="space-y-8 animate-slideUp">
          ...
          {persona && (
            <section>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-7 h-7 rounded-lg bg-orange-500 flex items-center justify-center text-white font-black text-[10px]">{profile?.persona_type ? '03' : '04'}</div>
                <h2 className="text-xl font-display font-black">Detailed Persona Attributes</h2>
              </div>
...
export default function Dashboard() {
  ...
  return (
    <div className={`min-h-screen pb-32 transition-colors duration-300 ${isVibeDark ? 'bg-[#0a0a0f] text-[#f0eff8] vibe-page dark' : 'bg-[#FAFAF9] text-[#111111]'}`}>
      <style dangerouslySetInnerHTML={{ __html: STYLES }} />
      ...
      <header className={`h-20 backdrop-blur-md border-b flex items-center px-4 md:px-8 sticky top-0 z-50 transition-colors duration-300 ${isVibeDark ? 'bg-[#13131a]/80 border-white/10' : 'bg-white/80 border-neutral-100'}`}>
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              <h1 className={`font-display text-2xl tracking-tight transition-colors duration-300 ${isVibeDark ? 'text-white' : 'text-[#111111]'}`}>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[9px] font-bold text-neutral-400 uppercase tracking-widest mt-1">{(profile?.wm_code || 'WM-NEW-000').replace('PT-', 'WM-')}</p>
              </div>
              <Avatar 
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12 pb-48">
        <div className={`tab-transition ${activeTab === 'analytics' ? 'tab-visible' : 'tab-hidden'}`}>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    style={{
                      padding: '8px 20px', borderRadius: 20, fontWeight: 700, fontSize: 12,
                      border: 'none', cursor: 'pointer', transition: 'all .2s',
                      background: isVibeDark 
                        ? (analyticsView === 'vibe' ? '#ffffff' : 'rgba(255, 255, 255, 0.08)')
                        : (analyticsView === 'vibe' ? '#111111' : '#f5f5f5'),
                      color: isVibeDark 
                        ? (analyticsView === 'vibe' ? '#111111' : 'rgba(255, 255, 255, 0.5)')
                        : (analyticsView === 'vibe' ? '#ffffff' : '#888888'),
                    }}
                  >
                    ✨ Vibe Stats
                  </button>
                  <button
                    ...
                    style={{
                      ...
                      border: 'none', cursor: 'pointer', transition: 'all .2s',
                      background: isVibeDark 
                        ? (analyticsView === 'classic' ? '#ffffff' : 'rgba(255, 255, 255, 0.08)')
                        : (analyticsView === 'classic' ? '#111111' : '#f5f5f5'),
                      color: isVibeDark 
                        ? (analyticsView === 'classic' ? '#111111' : 'rgba(255, 255, 255, 0.5)')
                        : (analyticsView === 'classic' ? '#ffffff' : '#888888'),
                    }}
                  >
                    📊 Reports
                  </button>
                ...
                <button
                  ...
                  style={{
                    padding: '8px 16px', borderRadius: 20, fontWeight: 700, fontSize: 12,
                    border: '1px solid var(--border)', cursor: 'pointer', transition: 'all .2s',
                    background: 'var(--surface)', color: 'var(--text)',
                  }}
                  className={`vibe-page ${vibeTheme === 'dark' ? 'dark' : ''}`}
                >
                  {vibeTheme === 'light' ? '🌙 Dark' : '☀️ Light'}
                </button>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-xl border border-neutral-100 shadow-sm hover:shadow-md transition-all relative group">
                <div className="flex justify-between items-center mb-4">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white rounded-2xl border border-neutral-100 shadow-sm overflow-visible flex flex-col">
              <div className="p-6 border-b border-neutral-50 flex justify-between items-center bg-neutral-50/30">
                <h3 className="text-sm font-black uppercase tracking-widest text-neutral-900 flex items-center gap-1.5">
                  ...
                  <div className="relative group flex shrink-0">
                    ...
                    <div className="absolute top-full left-0 mt-2 w-56 p-2.5 bg-neutral-900 text-white text-[10px] font-medium rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none z-50 shadow-xl border border-neutral-800 font-sans normal-case tracking-normal leading-normal select-none">
                      A timeline breakdown of scan traffic and unique visitors received over your selected period.
                    </div>
                  </div>
                </h3>
                <div className="flex gap-2">
                   <button className="px-3 py-1.5 bg-white border border-neutral-100 rounded-lg text-[10px] font-black uppercase text-neutral-400 shadow-sm">Filter</button>
                   <button className="px-3 py-1.5 bg-blue-500 text-white rounded-lg text-[10px] font-black uppercase shadow-sm">Deep Dive</button>
                </div>
              </div>
                ...
                <div className="flex justify-between items-center mb-8">
                   ...
                   <div className="flex gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-black uppercase text-neutral-400">Total Views</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-emerald-500" />
                        <span className="text-[9px] font-black uppercase text-neutral-400">Unique Views</span>
                      </div>
                   </div>
                </div>
              ...
              <div className="p-4 border-t border-neutral-50 text-center">
                 <button className="text-[10px] font-black uppercase text-neutral-400 hover:text-blue-500 transition-colors">View Detailed Timeline ›</button>
              </div>
            </div>

            <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm overflow-visible flex flex-col">
              <div className="p-6 border-b border-neutral-50 flex justify-between items-center bg-neutral-50/30">
                <h3 className="text-sm font-black uppercase tracking-widest text-neutral-900 flex items-center gap-1.5">
                  Latest Activities
                  <div className="relative group flex shrink-0">
                    <div className="w-3.5 h-3.5 rounded-full bg-neutral-200 text-[9px] font-bold text-neutral-400 flex items-center justify-center cursor-help shrink-0 select-none hover:bg-neutral-300 transition-colors">i</div>
                    <div className="absolute top-full right-0 mt-2 w-56 p-2.5 bg-neutral-900 text-white text-[10px] font-medium rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none z-50 shadow-xl border border-neutral-800 font-sans normal-case tracking-normal leading-normal select-none">
                      A real-time list of current visits, scans, and traffic sources coming into your phygital ecosystem.
                    </div>
                  </div>
                </h3>
              </div>
              <div className="flex-1 p-6">
                {!vibeStats.latestActivity?.length ? (
                  <div className="h-full flex flex-col items-center justify-center text-center space-y-4 opacity-40">
                    ...
                    <div>
                       <p className="font-black text-neutral-900">No Recent Activity</p>
                       <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-tight mt-1">New scans will appear here instantly</p>
                    </div>
                  </div>
                ) : (
                  <div className="space-y-6">
                    {vibeStats.latestActivity.slice(0, 5).map((ev, i) => (
                      <div key={i} className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-xl bg-neutral-50 border border-neutral-100 flex items-center justify-center shrink-0">
                           <Activity size={14} className="text-blue-500" />
                        </div>
                        <div className="flex-1">
                           <p className="text-[11px] font-black text-neutral-900 leading-tight">
                             {ev.is_repeat ? 'Repeat Visit' : (ev.referrer === 'qr' ? 'QR Code Scan' : 'Direct Link')} Detected
                           </p>
                           <p className="text-[9px] font-bold text-neutral-400 uppercase mt-1">{ev.device_type} • {ev.city || 'Unknown Location'}</p>
                        </div>
                        <span className="text-[9px] font-black text-neutral-300 uppercase shrink-0">
                          {ev.viewed_at ? new Date(ev.viewed_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : 'Just Now'}
                        </span>
                      </div>
                    ))}
                  </div>
              ...
              <div className="p-4 border-t border-neutral-50 text-center bg-neutral-50/30">
                 <button className="text-[10px] font-black uppercase text-neutral-400 hover:text-blue-500 transition-colors">See Live Feed ›</button>
              </div>
            </div>
          </div>
                ...
                <h3 className="text-sm font-black uppercase tracking-widest text-neutral-900 flex items-center gap-1.5">
                  ...
                  <div className="relative group flex shrink-0">
                    ...
                    <div className="absolute top-full left-0 mt-2 w-48 p-2.5 bg-neutral-900 text-white text-[10px] font-medium rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none z-50 shadow-xl border border-neutral-800 font-sans normal-case tracking-normal leading-normal select-none">
                      A geographical breakdown of where scans are coming from.
                    </div>
                  </div>
                </h3>
                ...
                {vibeStats.topCities.length > 0 ? (
                  vibeStats.topCities.map((loc, i) => (
                    <div key={i} className="flex items-center justify-between group cursor-pointer">
                      <div className="flex items-center gap-4">
                         <div className="w-8 h-8 rounded-lg bg-neutral-50 flex items-center justify-center text-xs font-black text-neutral-400 group-hover:bg-orange-50 group-hover:text-orange-600 transition-all">{loc.flag}</div>
                         <div>
                           <p className="text-xs font-black text-neutral-700">{loc.city}</p>
                           <p className="text-[9px] font-bold text-neutral-400 uppercase">{loc.country}</p>
                         </div>
                      </div>
                      <div className="text-right">
                         ...
                         <div className="w-16 h-1 bg-neutral-100 rounded-full mt-1 overflow-hidden">
                            <div className="h-full bg-orange-500" style={{ width: `${loc.barPct}%` }} />
                         </div>
                      </div>
                    </div>
                  ))
                  ...
                  <div className="py-10 text-center opacity-40">
                    <p className="text-xs font-bold uppercase tracking-widest">No Location Data Yet</p>
                    <p className="text-[10px] font-medium mt-1">Live scan locations will appear here</p>
                  </div>
                )}
              </div>
            </div>

...
export const personaConfigs: Record<string, PersonaConfig> = {
  fitness: {
    ...
    theme: {
      color: 'green',
      style: 'energetic',
      bg: 'linear-gradient(180deg, #022c22 0%, #0d1117 100%)',
      accent: '#10b981',
      textPrimary: '#ffffff',
      textSecondary: '#a7f3d0',
      cardBg: 'rgba(16, 185, 129, 0.08)',
      buttonBg: 'linear-gradient(135deg, #10b981, #34d399)',
      badgeStyle: 'bg-emerald-500/20 text-emerald-300'
    },
    fields: [
      { key: 'goal', label: 'Fitness Goal', type: 'text', placeholder: 'e.g. Build muscle' },
      { key: 'height', label: 'Height', type: 'text', placeholder: 'e.g. 175cm' },
      { key: 'weight', label: 'Weight', type: 'text', placeholder: 'e.g. 70kg' },
      { key: 'trainer', label: 'Trainer Name', type: 'text', placeholder: 'e.g. Coach Nanda' },
      { key: 'instagram', label: 'Instagram Handle', type: 'url', placeholder: 'e.g. https://instagram.com/yourhandle' },
      { 
        key: 'achievements',
        label: 'Achievements',
        type: 'array',
        itemSchema: [
          { key: 'label', label: 'Achievement Title', type: 'text', placeholder: 'e.g. 100kg Bench Press' }
        ]
      }
    ]
  },
  ...
  creator: {
    ...
    theme: {
      color: 'orange',
      style: 'creative',
      bg: 'linear-gradient(180deg, #431407 0%, #0f172a 100%)',
      accent: '#f97316',
      textPrimary: '#ffffff',
    ...
    fields: [
      { key: 'content_type', label: 'Specialty Formats', type: 'tags', suggestions: ['Video', 'Photography', 'Graphic Design', '3D Art', 'Podcasts'] },
      { key: 'portfolio', label: 'Portfolio Link', type: 'url', placeholder: 'https://behance.net/...' },
      { key: 'tools', label: 'Creative Tools', type: 'tags', suggestions: ['Figma', 'Photoshop', 'Premiere Pro', 'Blender', 'After Effects'] }
    ]
  },
  gamer: {
    id: 'gamer',
